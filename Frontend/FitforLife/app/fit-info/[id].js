...
const Fit = () => {
    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={{ backgroundColor: "white", marginTop: 4 }}>
            ...
            <TouchableOpacity onPress={()=>router.push("(drawer)/Home")} style={{ backgroundColor: "blue", padding: 10, marginLeft: "auto", marginRight: "auto", marginVertical: 20, borderRadius: 7, width: 120 }}>
                <Text style={{ textAlign: "center", fontWeight: "bold", color: "white", fontSize: 15 }}>Done</Text>
            </TouchableOpacity>
        </ScrollView>
    )
}
